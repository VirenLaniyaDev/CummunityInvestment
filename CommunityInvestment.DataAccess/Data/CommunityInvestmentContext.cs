...
namespace CommunityInvestment.DataAccess
{
    public partial class CommunityInvestmentContext : DbContext
    {
        ...
        public virtual DbSet<StoryViewCount> StoryViewCounts { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__comment__mission__093F5D4E");
            ...
            modelBuilder.Entity<ContactUs>(entity =>
            {
                entity.HasKey(e => e.ContactId)
                    .HasName("PK__contact___024E7A86179DD5D2");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__contact_u__user___6D9742D9");
            });
            ...
            modelBuilder.Entity<FavoriteMission>(entity =>
            {
                entity.HasKey(e => e.FavouriteMissionId)
                    .HasName("PK__favorite__94E4D8CAE3D3C436");
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__favorite___missi__10E07F16");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FavoriteMissions)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__favorite___user___5A846E65");
            });
            ...
            modelBuilder.Entity<GoalMission>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__goal_miss__missi__047AA831");
            });
            ...
            modelBuilder.Entity<Mission>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__city_id__0E04126B");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Missions)
                    .HasForeignKey(d => d.CountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__country__0EF836A4");

                entity.HasOne(d => d.Theme)
                    .WithMany(p => p.Missions)
                    .HasForeignKey(d => d.ThemeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__theme_i__0FEC5ADD");
            });
            ...
            modelBuilder.Entity<MissionApplication>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_a__missi__056ECC6A");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.MissionApplications)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_a__user___4F12BBB9");
            });
            ...
            modelBuilder.Entity<MissionDocument>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_d__missi__0662F0A3");
            });
            ...
            modelBuilder.Entity<MissionInvite>(entity =>
            {
                ...
                entity.HasOne(d => d.FromUser)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__from___5006DFF2");

                entity.HasOne(d => d.Mission)
                    .WithMany(p => p.MissionInvites)
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__missi__075714DC");

                entity.HasOne(d => d.ToUser)
                    .WithMany(p => p.MissionInviteToUsers)
                    .HasForeignKey(d => d.ToUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__to_us__50FB042B");
            });

            modelBuilder.Entity<MissionMedium>(entity =>
            {
                entity.HasKey(e => e.MissionMediaId)
                    .HasName("PK__mission___848A78E825EFA7C6");
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_m__missi__084B3915");
            });
            ...
            modelBuilder.Entity<MissionRating>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_r__missi__0A338187");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.MissionRatings)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_r__user___52E34C9D");
            });
            ...
            modelBuilder.Entity<MissionSkill>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .HasConstraintName("FK__mission_s__missi__0B27A5C0");
            ...
            modelBuilder.Entity<NotificationSetting>(entity =>
            {
                ...
                entity.Property(e => e.NewMissions)
                    .HasColumnName("new_missions")
                    .HasDefaultValueSql("((1))");

                entity.Property(e => e.NotificationByEmail)
                    .HasColumnName("notification_by_email")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.UserStories)
                    .HasColumnName("user_stories")
                    .HasDefaultValueSql("((1))");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__notificat__user___0169315C");
            });
            ...
            modelBuilder.Entity<Story>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story__mission_i__0C1BC9F9");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Stories)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story__user_id__53D770D6");
            });
            ...
            modelBuilder.Entity<StoryInvite>(entity =>
            {
                ...
                entity.HasOne(d => d.FromUser)
                    ...
                    .HasForeignKey(d => d.FromUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_inv__from___56B3DD81");
                ...
                entity.HasOne(d => d.ToUser)
                    ...
                    .HasForeignKey(d => d.ToUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_inv__to_us__57A801BA");
            });

            modelBuilder.Entity<StoryMedium>(entity =>
            {
                entity.HasKey(e => e.StoryMediaId)
                    .HasName("PK__tmp_ms_x__29BD053CA391FDDA");
                ...
                entity.Property(e => e.StoryPath).HasColumnName("story_path");
                ...
                entity.HasOne(d => d.Story)
                    ...
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_med__story__318258D2");
            });

            modelBuilder.Entity<StoryViewCount>(entity =>
            {
                entity.ToTable("story_view_count");

                entity.Property(e => e.StoryViewCountId).HasColumnName("story_view_count_id");
                ...
                entity.HasOne(d => d.Story)
                    .WithMany(p => p.StoryViewCounts)
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_vie__story__2AA05119");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.StoryViewCounts)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_vie__user___2B947552");
            });
            ...
            modelBuilder.Entity<Timesheet>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .HasConstraintName("FK__timesheet__missi__0D0FEE32");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Timesheets)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__timesheet__user___589C25F3");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    ...
                    .HasForeignKey(d => d.CityId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__users__city_id__54CB950F");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Users)
                    .HasForeignKey(d => d.CountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__users__country_i__55BFB948");
            });
            ...
            modelBuilder.Entity<UserNotification>(entity =>
            {
                ...
                entity.Property(e => e.NotificationFor)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("notification_for");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_noti__user___7226EDCC");
            });
            ...
            modelBuilder.Entity<UserSkill>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_skil__user___59904A2C");
            });
